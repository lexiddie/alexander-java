...
public class ElectrificationPlan1982 {
    ...
    public static void main(String[] args) {
        ...
        for (String value : s) {
            cities.add(Integer.parseInt(value));
        }
    ...
    private static class EGraph {
        ...
        private final Map<Integer, VE> map = new HashMap<>();
        ...
        class VE implements Comparable {
            private final Integer label;
            private final List<EEdge> inEdges;
            private final List<EEdge> outEdges;
        ...
        class EEdge implements Comparable {
            VE from;
            VE to;
            int weight;
